...
export const Discovery: StageComponent = ({ toNextPage }) => {
  ...
  const [ guessedLetters, setGuessedLetters ] = useState<{[key in typeof LETTERS[number]]?: boolean} >({})
  const [ wastedLetters, setWastedLetters ] = useState<{[key in typeof LETTERS[number]]?: boolean} >({})
  ...
  return (
    <div className={styles.discovery}>
            ...
            return (
              <span 
                ...
                className={combineClassNames(
                  styles.cell, 
                  (isWordGuessed || (!isWordGuessed && (guessedLetters[letter] || wastedLettersCount > 6))) ? styles.guessed : undefined
                )}
              >
      ...
      <div className={combineClassNames(styles.alphabet, (isWordGuessed || wastedLettersCount > 6) ? styles.disabled : undefined)}>
        {
          LETTERS.map(letter => {
            return (
              <button 
